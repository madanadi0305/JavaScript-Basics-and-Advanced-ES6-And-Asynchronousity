...
Open file named **task31.js** . Your task is to create a counter using a generator function that counts in reverse up to 0.
Your generator function should take a parameter that is used as a count value of that counter and Function should yield each count.
